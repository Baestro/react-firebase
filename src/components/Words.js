...
const databaseURL = "https://kr-ops-vk-operations-default-rtdb.firebaseio.com/";
...
class Words extends React.Component {
  ...
  _post(word) {
    return fetch(`${databaseURL}/words.json`, {
      ...
      .then((data) => {
        // The data added only will be transmitted.
  ...
  //function provided by React will be executed when components(page) are mounted
  componentDidMount() {
    this._get();
  }
